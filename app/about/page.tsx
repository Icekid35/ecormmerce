  ...
  return (
    <div  className='flex flex-col  w-full gap-10 pb-10 pt-4 md:pt-14 px-2 md:px-10'>
        <div className='grid gap-6 grid-cols-[repeat(auto-fit,minmax(250px,1fr))]'>
            ...
            <div className='md:h-[500px] h-[300px] bg-slate-500 rounded md:min-w-[500px] min-w-[300px] '>

            </div>
        </div>
        <div className='flex flex-wrap w-full md:px-8  justify-center gap-6 cursor-pointer text-center capitalize'>
            <div className='p-4 h-[150px] w-[150px] rounded flex flex-col items-center border gap-4  justify-items-center border-slate-500  hover:bg-red-500 hover:text-white hover:border-none'>
                <div>
